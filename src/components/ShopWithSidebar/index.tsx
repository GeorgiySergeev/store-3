...
const ShopWithSidebar = () => {
  ...
  const [watchAllCategories, setWatchAllCategories] = useState(false);
  const [watchAllSubcategories, setWatchAllSubcategories] = useState(false);
  const [watchAllThirdLevelCategories, setWatchAllThirdLevelCategories] = useState(false);
