...
const Header = () => {
  ...
  const options = [
    { label: 'Всі категорії', value: '0' },
    { label: 'Велосипеди', value: '1' },
    { label: 'Електровелосипеди', value: '2' },
    { label: 'Запчастини', value: '3' },
    { label: 'Аксесуари', value: '4' },
  ];
        ...
        <div
          ...
          <div className="xl:w-auto flex-col sm:flex-row w-full flex sm:justify-between sm:items-center gap-5 sm:gap-10">
            <Link className="flex-shrink-0" href="/">
              <Image src="/images/logo/logo-orange.png" alt="Logo" width={219} height={36} />
            </Link>
          ...
          <div className="flex w-full lg:w-auto items-center gap-7.5">
            <div className="hidden xl:flex items-center gap-3.5">
              ...
              <div>
                <p className="font-medium text-custom-sm text-dark">+380(69) 123-45-69</p>
              </div>
            </div>
            ...
            <div className="flex w-full lg:w-auto justify-between items-center gap-5">
              <div className="flex items-center gap-5">
                <button onClick={handleOpenCartModal} className="flex items-center gap-2.5">
                  ...
                  <div>
                    <span className="block text-2xs text-dark-4 uppercase">кошик</span>
                    <p className="font-medium text-custom-sm text-dark">{totalPrice} грн.</p>
                  </div>
                </button>
              </div>
                  ...
                  {menuData.map((menuItem, i) =>
                    menuItem.submenu ? (
                      ...
                      <li
                        ...
                        <Link
                          href={menuItem.path}
                          className={`hover:text-blue text-custom-sm uppercase font-medium text-dark flex ${
