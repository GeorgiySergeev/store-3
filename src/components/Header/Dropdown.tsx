...
const Dropdown = ({ menuItem, stickyMenu }) => {
  ...
  return (
    <li
      ...
      <a
        href="#"
        className={`hover:text-blue    font-medium text-dark flex items-center gap-1.5  ${
      ...
      <ul
        ...
        {menuItem.submenu.map((item, i) => (
          <li key={i}>
            <Link
              href={item.path}
              className={`flex text-custom-sm upercase hover:text-blue hover:bg-gray-1 py-[7px] px-4.5 ${
