...
const Footer = () => {
  ...
  return (
    <footer className="overflow-hidden">
      <div className="container  px-4 sm:px-8 xl:px-0">
        {/* <!-- footer menu start --> */}
        <div className="flex flex-wrap xl:flex-nowrap gap-10 xl:gap-19 xl:justify-between pt-17.5 xl:pt-22.5 pb-10 xl:pb-15">
          <div className="max-w-[330px] w-full">
            <h2 className="mb-7.5 text-custom-1 font-medium text-dark">Контакти</h2>
          ...
          <div className="w-full sm:w-auto">
            <h2 className="mb-7.5 text-custom-1 font-medium text-dark">Магазин</h2>
          ...
          <div className="w-full sm:w-auto">
            <h2 className="mb-7.5 text-custom-1 font-medium text-dark">Корисні ссилки</h2>
            ...
            <ul className="flex flex-col gap-3">
              ...
              <li>
                <a className="ease-out duration-200 hover:text-blue" href="#"></a>
              </li>
              <li>
                <a className="ease-out duration-200 hover:text-blue" href="#">
          ...
          <div className="w-full sm:w-auto">
            ...
            <p className="lg:text-right text-custom-sm mb-4">
              Продаж та обслуговування велосипедів.
            </p>
          </div>
        </div>
        {/* <!-- footer menu end --> */}
      ...
      <div className="py-5 xl:py-7.5 bg-gray-1">
        <div className="max-w-[1170px] mx-auto px-4 sm:px-8 xl:px-0">
          <div className="flex gap-5 flex-wrap items-center justify-between">
            <p className="text-dark font-medium">&copy; {year}. Developed by </p>

            <div className="flex flex-wrap items-center gap-4">
              <p className="font-medium">Ми приймаємо:</p>
